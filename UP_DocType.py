...
def dump_dt(excel_file):
    ...
    for sheet_name, df_sheet in sheets_dict.items():
        ...
        # ✅ FIXED: Use 'excel_file' instead of 'file'
        output_file = excel_file.replace(".xlsx", "_" + sheet_name + ".json")
        with open(output_file, "w", encoding="utf-8") as f:
            f.write(pretty_json)


# 读取所有 Sheets
file = ["Account.xlsx", "AccountHistory.xlsx", "Contract__c.xlsx", "Contract__History.xlsx",
        "Invoice__c.xlsx", "InvoiceDetail__c.xlsx", "VacancyAccept__History.xlsx"]
